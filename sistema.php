...
<html lang="pt-br">
	...
	$(document).ready(function(){
		...
		$("#categoria").on("click",function(){
			$("#principal").load("./ticket/import.php");
                        $('#ocultaformulario').css('display','inline-block');
                        $('#mostraformulario').css('display','none');
		});
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button type="button" class="btn btn-success" id="categoria">
                        Carregar
                    </button>
                    
                    <button type="button" class="btn btn-success" id="contas">
                        Ver meus tickets
                    </button>
